 ...
 * Type T is a TimeGraphEntry and Type U is an EntryHeader
 */
export interface TimeGraphEntryResponse<T extends TimeGraphEntry, U extends EntryHeader> extends GenericEntryResponse<T> {
    headers: U[];
}
